 ...
 *
 * This script is based on the one freely available at,
 ...
 * Which forms the basis of the android developers guide to Bluetooth LE
 */
...
public class BluetoothLeService extends Service {
    ...
    private void broadcastUpdate(final String action,
        ...
        if (data != null && data.length > 0) intent.putExtra(EXTRA_DATA, data);
        sendBroadcast(intent);
    }
    ...
    public void scanLeDevices(final boolean enable, ScanCallback mScanCallback) {
     ...
     * Writes the given value to the given characteristic locally and publishes it to the GATT
     * Server
